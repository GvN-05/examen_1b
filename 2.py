...
try:
    db = server.create('resultados_track')
except:
    db = server['resultados_track']
    
'''===============LOCATIONS=============='''    

#twitterStream.filter(locations=[-104.206348,47.696082,-104.13905,47.729586])  # Sidney
twitterStream.filter(track=['coronavirus','covid'])
